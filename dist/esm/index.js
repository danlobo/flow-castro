...
const ThemeProvider = ({
  ...
  const [currentTheme, setCurrentTheme] = useState(_themes[theme] || _themes.light);
...
const ContextMenuList = ({
  ...
  return /*#__PURE__*/jsxs("ul", {
    ...
    }), activeOption?.description && /*#__PURE__*/jsx("li", {
      children: /*#__PURE__*/jsx("div", {
...
function useElementSelection({
   ...
   */
  const isWaypointSelected = useCallback(waypointInfo => {
  ...
  const processAreaSelection = useCallback((selectionArea, selectionMode, nodesInArea, waypointsInArea = []) => {
...
function useClipboard({
   ...
   */
  const copyNodesToClipboard = useCallback(selectedNodes => {
   ...
   */
  const pasteNodesFromClipboard = useCallback((currentPointer = null) => {
...
function useNodeOperations({
   ...
   */
  const addWaypoint = useCallback((srcNode, srcPort, dstNode, dstPort, position) => {
    setStateAndNotify(prev => {
      var _prev$nodes5;
      const newNodes = {
   ...
   */
  const updateWaypointPosition = useCallback((srcNode, srcPort, dstNode, dstPort, waypointIndex, newPosition) => {
    setStateAndNotify(prev => {
      var _prev$nodes6;
      const newNodes = {
   ...
   */
  const removeWaypoint = useCallback((srcNode, srcPort, dstNode, dstPort, waypointIndex) => {
    setStateAndNotify(prev => {
      var _prev$nodes7;
      const newNodes = {
   ...
   */
  const updateNodeValues = useCallback((id, values) => {
    setStateAndNotify(prev => {
      return {
        ...prev,
        nodes: {
...
function useElementMovement({
  ...
  const moveHandler = useCallback((node, position, notify) => {
...
function Screen({
  ...
  const [lastConnectionSuccessful, setLastConnectionSuccessful] = useState(false);
  ...
  return /*#__PURE__*/jsx("div", {
    ...
    children: /*#__PURE__*/jsx(TransformWrapper, {
      ...
      children: ({
        ...
        return /*#__PURE__*/jsxs(Fragment, {
          children: [/*#__PURE__*/jsx(SelectionArea, {
            localStartPoint: localStartPoint,
            localEndPoint: localEndPoint
          }), /*#__PURE__*/jsx(ToolbarVertical, {
            zoomIn: zoomIn,
            zoomOut: zoomOut,
          ...
          }), /*#__PURE__*/jsx(ToolbarHorizontal, {
            snapToGrid: snapToGrid,
            handleSnapToGrid: handleSnapToGrid,
            viewMode: viewMode
          }), /*#__PURE__*/jsx(StatusPanel, {
            scale: scale,
            position: position
            ...
            children: ({
              ...
              children: [state?.nodes && Object.values(state.nodes).map((node, index) => {
                ...
                if (node.type === "comment") return /*#__PURE__*/jsx(Comment, {
                  nodeId: node.id,
                  text: node.value || "",
                  title: node.title || "",
              ...
              }), (dragInfo || isInFadeout) && dstDragPosition ? /*#__PURE__*/jsx(ConnectorCurveForward, {
                tmp: true,
                invalid: isInFadeout,
                src: {
